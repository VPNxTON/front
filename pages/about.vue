...
<template>
 <v-container  class="page-container">
   ...
   <p class="text-h6 mb-16 ">
     ...
     support?
     <br>
     How involve community extend network and improve the quality of services?
   </p>
   <h3 class="text-h4 font-weight-bold mb-6 title">
     Suggested
   </h3>
   ...
   <p class="text-h6 mb-16">
     Allow TON community add his own server to VPN
     service <br>
     Use Jettons and TON coins to pay for VPN access <br>
     Use smart contract for manage and control VPN server
   </p>
 </v-container>
</template>
